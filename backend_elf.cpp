...
int main () {
    ...
    Code code2 (128);
    code2.add_command (Idiv_R (REGS::RAX));
    code2.add_command (Idiv_R (REGS::RCX));
    code2.add_command (Idiv_R (REGS::RDX));
    code2.add_command (Idiv_R (REGS::RBX));
    code2.add_command (Idiv_R (REGS::RSI));
