...
int main () {
    ...
    Code code2 (128);
    code2.add_command (Sub64_RM (REGS::RAX, -100));
    code2.add_command (Sub64_RM (REGS::RAX, -200));
    code2.add_command (Sub64_RM (REGS::RCX, -100));
    code2.add_command (Sub64_RM (REGS::RCX, -200));
    code2.add_command (Sub64_RM (REGS::RDX, -100));
