...
int main () {
    ...
    Code code2 (128);
    code2.add_command (Sub64_RImm (REGS::RAX, 100));
    code2.add_command (Sub64_RImm (REGS::RAX, 200));
    code2.add_command (Sub64_RImm (REGS::RCX, 100));
    code2.add_command (Sub64_RImm (REGS::RCX, 200));
    code2.add_command (Sub64_RImm (REGS::RDX, 100));
